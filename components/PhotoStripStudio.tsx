...
export default function PhotoStripStudio({
  ...
  const requestSendToDiscord = () => {
    ...
    setConfirmAction({
      ...
      confirmClassName: 'bg-[#5865F2] hover:bg-[#4752C4] text-paper-light border border-[#4752C4]/40 shadow-print',
      confirmIcon: (
        <svg className="w-3.5 h-3.5 text-paper-light shrink-0" viewBox="0 0 24 24" fill="currentColor">
  ...
  const requestDownload = () => {
    ...
    setConfirmAction({
      ...
      confirmClassName: 'bg-rust hover:bg-rust-dark text-paper-light border border-rust-dark/30 shadow-print',
      confirmIcon: (
        <svg
          className="w-3.5 h-3.5 text-paper-light shrink-0"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2.5"
    ...
    <>
      ...
      {confirmAction && (
        <ConfirmDialog
          ...
          confirmIcon={confirmAction.confirmIcon}
